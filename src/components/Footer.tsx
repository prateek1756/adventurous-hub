              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <a href="tel:+917795601XXX" className="text-accent-foreground/80 hover:text-accent-foreground transition-colors duration-300">
                      +91 7795601XXX
                    </a>
                  </div>
                </li>
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-accent-foreground/80 text-base">prateekchand1756@gmail.com</span>
                </li>
              </ul>
            </div>
