  ...
  const activities = [
    {
      ...
      image: "/img-upload/1d3255ca-7296-4e20-b1fb-416cfb82fa82.png",
      duration: "2-3 hours",
      difficulty: "Moderate",
    ...
    },
    {
      ...
      image: "/img-upload/dc56b3d5-8de2-40a9-b259-35829487f125.png",
      duration: "3-4 hours",
      difficulty: "Easy",
    ...
    },
    {
      ...
      image: "/img-upload/41b176ee-c1a4-467f-8c90-a34ecc92fb8b.png",
      duration: "4-5 hours",
      difficulty: "Moderate",
    ...
    },
    {
      ...
      image: "/img-upload/504eed73-ca66-4273-aa1a-905482b892fe.png",
      duration: "1-2 hours",
    ...
    },
    {
      ...
      image: "/img-upload/07e0c5d8-5e69-46ba-918d-1d36153e73dd.png",
      duration: "1-2 hours",
      difficulty: "Easy",
    ...
    },
    {
      ...
      image: "/img-upload/a86fb74f-d5e7-48b5-a676-777476545216.png",
      duration: "3-4 hours",
      difficulty: "Easy",
      groupSize: "4-8 people",
      rating: 4.6,
      ...
      <main className="flex-grow pt-20">
        ...
        <section className="relative h-[40vh] md:h-[50vh] lg:h-[60vh] overflow-hidden">
          <div className="absolute inset-0">
            <img 
              src="/img-upload/1d3255ca-7296-4e20-b1fb-416cfb82fa82.png" 
              ...
              {[
                {
                  ...
                  image: "/img-upload/61d7b6e2-720c-42fc-a459-7624b56b81d0.png"
                },
                {
        ...
        <section className="py-20 bg-accent text-accent-foreground relative">
          <div className="absolute inset-0 bg-[url('/img-upload/1d3255ca-7296-4e20-b1fb-416cfb82fa82.png')] bg-cover bg-center opacity-20"></div>
